Locales['fr'] = {
  ...
  ['weapon_combatpistol'] = 'pistolet de combat', -- tout marche
  ...
  -- == WEAPON_SWITCHBLADE == --
  ['component_handle_default'] = 'Poignée de composant par défaut',
  ['component_handle_vip'] = 'Poignée vip',
  ['component_handle_bodyguard'] = 'Poignée du composant garde-corps',
  -- == Autre  == --
  ['weapon_ceramicpistol'] = 'pistolet en céramique', -- dead
  --['component_handle_vip'] = 'Poignée vip',
  --['component_handle_vip'] = 'Poignée vip',
  --['component_handle_vip'] = 'Poignée vip',
  --['component_handle_vip'] = 'Poignée vip',
