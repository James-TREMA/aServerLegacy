...
--
	...
	self.addWeaponAmmo = function(weaponName, ammoCount) -- fix for ammo not updating on clients
		local loadoutNum, weapon = self.getWeapon(weaponName)
	...
	self.updateWeaponAmmo = function(weaponName, ammoCount) -- fix for ammo not updating on clients
		local loadoutNum, weapon = self.getWeapon(weaponName)
