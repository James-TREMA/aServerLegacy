...
RegisterNUICallback('register', function(data, cb)
	...
	if reason == nil then
		TriggerServerEvent('esx_identity:setIdentity1', data, myIdentifiers)
		EnableGui(false)
		Citizen.Wait(500)
		ResetSkin()
...
ResetSkin = function() -- Remais de base le skin du joueurs
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        if skin == nil then
          TriggerEvent('skinchanger:loadSkin', {sex = 0})
          --print("Passe dans skinchanger:loadSkin 1")
        else
          TriggerEvent('skinchanger:loadSkin', skin)
            --print("Passe dans skinchanger:loadSkin 2")
        end
    end)
end
